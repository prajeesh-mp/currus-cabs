        ...
        <main className="px-6 md:px-8 flex-1 space-y-10 md:space-y-0">
            <div className="flex flex-col md:flex-row items-center justify-center w-full">
                ...
                <div className="w-full max-w-md space-y-4 text-center md:text-left">
                    <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold leading-tight">We’ll take you places</h2>
                ...
                {/* Map Section */}
                <div className="relative w-full md:w-1/2 min-h-[250px] sm:min-h-[300px] md:min-h-[400px] bg-gray-100 rounded-lg overflow-hidden mt-6 md:mt-0">
